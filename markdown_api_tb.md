...
error_response
```
## **31. attendance request **

**URL** : `/request/attendance/count`
...
```json
{"status":true,"message":"success","data":{"category":{"pending":{"total":6,"clockin":1,"update_log":1,"compoff":0,"shift_change":4},"approved":{"total":0,"clockin":0,"update_log":0,"compoff":0,"shift_change":0},"rejected":{"total":1,"clockin":0,"update_log":0,"compoff":1,"shift_change":0},"revoked":{"total":0,"clockin":0,"update_log":0,"compoff":0,"shift_change":0}},"total":7}}
```
## **32. attendance request **

**URL** : `/request/attendance/list`
...
```json
{
  ...
  "year":"2018",
  "request_status":1,
  "att_request_type": [1,2]
}
```
### Success Responses

```json
{"status":true,"message":"success","data":{"requests":[{"id":1,"employee_id":1,"employee_name":"Ankit Vishwakarma","att_request_type":1,"att_request_sub_type":1,"date":null,"clockin_time":null,"clockout_time":null,"buttons":[{"control_type":"button","action_id":2,"text":"Approve"},{"control_type":"button","action_id":4,"text":"Reject"}],"created_at":{"date":"2018-04-04 00:00:00.000000","timezone_type":3,"timezone":"UTC"}},{"id":2,"employee_id":1,"employee_name":"Ankit Vishwakarma","att_request_type":2,"att_request_sub_type":1,"date":null,"clockin_time":null,"clockout_time":null,"buttons":[{"control_type":"button","action_id":2,"text":"Approve"},{"control_type":"button","action_id":4,"text":"Reject"}],"created_at":{"date":"2018-04-04 00:00:00.000000","timezone_type":3,"timezone":"UTC"}}]}}
```
## **33. attendance request **

**URL** : `request/shift/list`
...
```json
{"status":true,"message":"success","data":{"requests":[{"id":1,"employee_id":1,"employee_name":"Ankit Vishwakarma","att_request_type":5,"credited_date":"2018-04-04","compoff_type_id":1,"credited_balance":2,"comment":null,"button":[{"control_type":"button","action_id":2,"text":"Approve"},{"control_type":"button","action_id":4,"text":"Reject"}]}]}}
```
## **35. attendance request **

**URL** : `request/attendance/detail/`
...
```json
{
  ...
  "requests": [
    {
            "employee_id":4,
      "shift_date": "2017-03-05",
      "sender_source_id": 1,
      "att_request_type": 1,
      "att_request_sub_type": 1,
      "is_next_day": 0,
      "comment":"forgot",
      "clockin_time":"10:00:00",
      "clockout_time":"18:00:00"
    }
  ]
}
```
...
```
## **45. Attendance Request - Work Type Allowed **

**URL** : `/request/attendance/worktype`
...
```json
{
    ...
    "data": [
        ...
        {
            "att_request_sub_type": 2,
            "name": "Work From Home"
        },
        {
            "att_request_sub_type": 3,
            "name": "Out Duty"
        }
    ]
}
```
## **46. Auto Generate Request Count**

**URL** : `request/autogenerate/action`
...
```json
{"status":true,"message":"Success","data":{"request_status":"Pending","period":{"month":3,"year":2018},"request_type":{"attendance":{"absent":5},"leave":{"absent":2,"late":1,"wd":1}},"total":9}}
```
## **47. Auto Generate Request List**

**URL** : `request/autogenerate/list`
...
```json
{"sender_source_id":1,"from_date":"2017-03-09","to_date":"2017-03-09","from_time":"11:00:00","to_time":"13:00:00"}(employee) or  {"sender_source_id":1,"from_date":"2017-03-09","to_date":"2017-03-09","requested_shift_id":1}(admin)
```
### Success Responses
...
```
## **51. shift request metadata**

**URL** : `request/shift/metadata`
...
```json
{"status":true,"message":"success","data":{"reportees":{"1":{"id":2,"full_name":"Kiran Dhokne"},"2":{"id":3,"full_name":"Vishal Khoje"},"3":{"id":4,"full_name":"Sanket Bhoir"},"4":{"id":5,"full_name":"Neelam Somarde"}},"shifts":[{"id":1,"name":"regular","description":"","daily_work_hours":null,"is_daily_mandatory":0,"weekly_work_hours":null,"is_weekly_mandatory":0,"monthly_work_hours":null,"is_monthly_mandatory":0,"shift_type_id":1,"shift_color":"#0821db","detail":[{"id":1,"shift_start_time":"10:00:00","shift_end_time":"18:00:00","is_day_night_shift":0,"early_cutoff_hours":"09:00:00","end_cutoff_hours":"19:00:00"}]},{"id":2,"name":"Afternoon","description":"","daily_work_hours":null,"is_daily_mandatory":0,"weekly_work_hours":null,"is_weekly_mandatory":0,"monthly_work_hours":null,"is_monthly_mandatory":0,"shift_type_id":1,"shift_color":"#db7f06","detail":[{"id":2,"shift_start_time":"12:00:00","shift_end_time":"21:00:00","is_day_night_shift":0,"early_cutoff_hours":"11:00:00","end_cutoff_hours":"22:00:00"}]}]}}(admin or manager)  or {"status":true,"message":"success","data":{"title":"You are currently assigned to “regular” and your shift-timings are “10:00:00 to 18:00:00”"}}(employee)
```
## **52. Action Leave**

**URL** : `/leave/actionleavePOST`
...
```
## **53. Load partcular leave**

**URL** : `/leave//request/loadLeave`
...
```json
{
    ...
    "data": {
        "id": 2,
        "is_unpaid": 0,
        "title": "Kushal Pandy has requested a general leave for Ankit Vishwakarma",
        "sub_title": "Date: 2018-02-02 to 2018-02-22",
        "comment": "Due to overutilizaton,system geneater the request",
        "fields": [
            {
                "control_type": "radio",
                "id": 4,
                "text": "Count Full Leave as paid",
                "value": "checked"
            },
            {
                "control_type": "radio",
                "id": 1,
                "text": "Count Full Leave as unpaid",
                "value": "unchecked"
            }
        ],
        "request_logs": [],
...
```
## **54. Action optional holiday request**

**URL** : `leave/request/actionleave`
...
```
## **55. Load Particular optional holiday request**
...
{
    "status": true,
    "message": "Request load successfully",
    "data": {
        "id": 1,
        "is_unpaid": "",
        "title": "Kiran Dhokne has applied to update their Optional Holiday",
        "sub_title": "Holidays Removed: [ Republican Day ( 2018-04-25 )],[ Crismus Day ( 2018-04-26 )], \n Holidays Added: [ Independent Day ( 2018-04-24 )],",
        "comment": "hi",
        "fields": [],
        "request_logs": [],
        "action_buttons": []
...
```
## **56. Leave Request  count**

**URL** : `request/leave/count`
...
```json
{
  ...
  "year":"2018",
  "request_status":2
 "sub_leave_type_id": [1,2] (optional)
}
```
### Success Responses

```json
{"status":true,"message":"success","data":{"leave_requests":[{"id":2,"employee_id":3,"employee_name":"Vishal Khoje","leave_name":"General","form_date":"2018-03-15","to_date":"2018-03-15","total":1,"buttons":[{"control_type":"button","id":3,"text":"Revoke"}]},{"id":10,"employee_id":4,"employee_name":"Sanket Bhoir","leave_name":"Maternity","form_date":"2018-03-15","to_date":"2018-03-15","total":1,"buttons":[{"control_type":"button","id":3,"text":"Revoke"}]},{"id":2,"employee_id":2,"employee_name":"Kiran Dhokne","leave_name":"Short Leave","form_date":"2018-03-01 00:00:00","to_date":"2018-03-16 00:00:00","total":"04:00:00","buttons":[{"control_type":"button","id":3,"text":"Revoke"}]}],"optional_holiday_request":[{"id":2,"employee_id":1,"employee_name":"Ankit Vishwakarma","leave_name":"Optional Holiday","form_date":"-","to_date":"-","total":"-","buttons":[]},{"id":6,"employee_id":2,"employee_name":"Kiran Dhokne","leave_name":"Optional Holiday","form_date":"-","to_date":"-","total":"-","buttons":[3]}]}}
```
## **58. Load All Employee  leave requests**

**URL** : `/leave//request/loadempallleaves`
    ...
    "data": [
        {
            "id": 10,
            "is_unpaid": 0,
            "title": "Kiran Dhokne has requested a sick",
            "sub_title": "Date: 2018-03-22 to 2018-03-23",
            "comment": "Hi",
            "fields": [],
            "request_logs": [],
            "action_buttons": [
        ...
        },
        {
            ...
            "is_unpaid": 0,
            "title": "Kiran Dhokne has requested a sick",
            "sub_title": "Date: 2018-03-24 to 2018-03-24",
            "comment": "Hi",
            "fields": [
                {
                    "control_type": "radio",
        ...
        },
        {
            ...
            "is_unpaid": 0,
            "title": "Kiran Dhokne has requested a sick",
            "sub_title": "Date: 2018-03-26 to 2018-03-26",
            "comment": "Hi",
            "fields": [
                {
                    "control_type": "radio",
        ...
        },
        {
            ...
            "is_unpaid": 0,
            "title": "Kiran Dhokne has requested a sick",
            "sub_title": "Date: 2018-03-28 to 2018-03-28",
            "comment": "Hi",
            "fields": [
                {
                    "control_type": "radio",
        ...
        },
        {
            ...
            "is_unpaid": 1,
            "title": "Kiran Dhokne has requested a sick",
            "sub_title": "Date: 2018-03-01 to 2018-03-02",
            "comment": null,
            "fields": [],
            "request_logs": [],
            "action_buttons": []
        },
        {
            "id": 13,
            "is_unpaid": 0,
            "title": "Kiran Dhokne has requested a Short Leave",
            "sub_title": "Date: 2018-02-20 10:00:00 to 2018-02-20 10:30:00",
            "comment": "Hi",
            "fields": [],
            "request_logs": [],
            "action_buttons": [
        ...
        },
        {
            "id": 10,
            "is_unpaid": 0,
            "title": "Kiran Dhokne has requested a compff w and O",
            "sub_title": "Date: 2018-03-22 to 2018-03-23",
            "comment": "Hi",
            "fields": [],
            "request_logs": [],
        ...
        },
        {
            "id": 10,
            "is_unpaid": 0,
            "title": "Kiran Dhokne has requested a unpaid",
            "sub_title": "Date: 2018-03-22 to 2018-03-23",
            "comment": "Hi",
            "fields": [],
            "request_logs": [],
